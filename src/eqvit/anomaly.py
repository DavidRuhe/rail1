...
from rail1 import fit, fire, optimizers, loggers, schedulers
import datasets
import models
import functools
...
def main(config):
    ...
    scheduler = schedulers.CosineAnnealingLR(optimizer, **config["scheduler"])
